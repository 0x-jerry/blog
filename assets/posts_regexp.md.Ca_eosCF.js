...
<span class="line"><span></span></span>
<span class="line"><span>1.2.3.2555</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 匹配 IP 地址</span></span>
<span class="line"><span>\\b((1\\d{2}|2[0-4]\\d|25[0-5]|\\d{1,2})\\.){3}(1\\d{2}|2[0-4]\\d|25[0-5]|\\d{1,2})\\b</span></span></code></pre></div><p>结果图：</p><p><img src="`+l+'" alt="匹配结果"></p><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h2><ul><li>正则表达式 - 维基百科，自由的百科全：<a href="https://zh.wikipedia.org/wiki/%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F" target="_blank" rel="noreferrer">https://zh.wikipedia.org/wiki/正则表达式</a></li></ul>',20),i=[p];function r(o,d,c,h,g,u){return n(),s("div",null,i)}const _=a(t,[["render",r]]);export{k as __pageData,_ as default};
